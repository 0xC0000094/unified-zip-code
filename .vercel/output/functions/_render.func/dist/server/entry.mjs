...
import { A as REROUTABLE_STATUS_CODES, D as ASTRO_GENERATOR, E as ASTRO_ERROR_HEADER, F as pipelineSymbol, I as responseSentSymbol$1, M as clientAddressSymbol, N as fetchStateSymbol, O as DEFAULT_404_COMPONENT, P as originPathnameSymbol, S as renderEndpoint, T as isRoute500, _ as isRenderInstruction, a as chunkToString, b as isAstroComponentFactory, c as isRenderTemplateResult, d as decryptString, f as generateCspDigest, i as renderComponent, j as appSymbol, k as REDIRECT_STATUS_CODES, l as renderTemplate, n as renderPage, o as createSlotValueFromString, r as renderJSX, s as renderSlotToString, u as decodeKey, v as normalizeCspResourceEntry, w as isRoute404, y as pushDirective } from "./chunks/server_K0Xh0dyq.mjs";
...
var middlewareSecret = "9115119b-14ca-4a54-9250-ef78d68ecb86";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"SITE": "https://zip.jamesventura.dev",
			"SSR": true
		}, { _: "/home/unknxwn/.nvm/versions/node/v24.12.0/bin/npx" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://zip.jamesventura.dev",
			"SSR": true
		}, { _: "/home/unknxwn/.nvm/versions/node/v24.12.0/bin/npx" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/barangays.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/lookup.ts",
			"pathname": "/api/lookup",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/municipalities.ts",
			"pathname": "/api/municipalities",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/provinces.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/index.ts",
			"pathname": "/api",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/generic_eLrTw7jb.mjs");
var _page1 = () => import("./chunks/barangays_BvHahp-J.mjs");
var _page2 = () => import("./chunks/lookup_BhlF_n3A.mjs");
var _page3 = () => import("./chunks/municipalities_BUDf44g1.mjs");
var _page4 = () => import("./chunks/provinces_BgMEicvG.mjs");
var _page5 = () => import("./chunks/search_BsUXn1mi.mjs");
var _page6 = () => import("./chunks/index_vEAzdbLX.mjs");
var _page7 = () => import("./chunks/index_XEh3dWTk.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/api/barangays.ts", _page1],
	["src/pages/api/lookup.ts", _page2],
	["src/pages/api/municipalities.ts", _page3],
	["src/pages/api/provinces.ts", _page4],
	["src/pages/api/search.ts", _page5],
	["src/pages/api/index.ts", _page6],
	["src/pages/index.astro", _page7]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///home/unknxwn/projects/portfolio/unified-zip-code/","cacheDir":"file:///home/unknxwn/projects/portfolio/unified-zip-code/node_modules/.astro/","outDir":"file:///home/unknxwn/projects/portfolio/unified-zip-code/dist/","srcDir":"file:///home/unknxwn/projects/portfolio/unified-zip-code/src/","publicDir":"file:///home/unknxwn/projects/portfolio/unified-zip-code/public/","buildClientDir":"file:///home/unknxwn/projects/portfolio/unified-zip-code/dist/client/","buildServerDir":"file:///home/unknxwn/projects/portfolio/unified-zip-code/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/barangays","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/barangays\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"barangays","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/barangays.ts","pathname":"/api/barangays","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/lookup","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/lookup\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"lookup","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/lookup.ts","pathname":"/api/lookup","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/municipalities","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/municipalities\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"municipalities","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/municipalities.ts","pathname":"/api/municipalities","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/provinces","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/provinces\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"provinces","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/provinces.ts","pathname":"/api/provinces","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/search","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/search\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"search","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/search.ts","pathname":"/api/search","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api","isIndex":true,"type":"endpoint","pattern":"^\\/api\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/index.ts","pathname":"/api","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/index.Bth6dTGz.css"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","site":"https://zip.jamesventura.dev","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/home/unknxwn/projects/portfolio/unified-zip-code/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.CaH7gijW.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/api/barangays@_@ts":"chunks/barangays_BvHahp-J.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_eLrTw7jb.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_XEh3dWTk.mjs","\u0000virtual:astro:page:src/pages/api/index@_@ts":"chunks/index_vEAzdbLX.mjs","\u0000virtual:astro:page:src/pages/api/lookup@_@ts":"chunks/lookup_BhlF_n3A.mjs","\u0000virtual:astro:page:src/pages/api/municipalities@_@ts":"chunks/municipalities_BUDf44g1.mjs","\u0000virtual:astro:page:src/pages/api/provinces@_@ts":"chunks/provinces_BgMEicvG.mjs","\u0000virtual:astro:page:src/pages/api/search@_@ts":"chunks/search_BsUXn1mi.mjs","/home/unknxwn/projects/portfolio/unified-zip-code/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_CMfN-Awy.mjs","/home/unknxwn/projects/portfolio/unified-zip-code/src/pages/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.ZF6kvm3a.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/home/unknxwn/projects/portfolio/unified-zip-code/src/pages/index.astro?astro&type=script&index=0&lang.ts","var e=document.querySelector(`#q`),t=document.querySelector(`#results`),n=document.querySelector(`#req`),r=document.querySelector(`#req-url`),i=e=>String(e).replace(/[&<>\"']/g,e=>({\"&\":`&amp;`,\"<\":`&lt;`,\">\":`&gt;`,'\"':`&quot;`,\"'\":`&#39;`})[e]??e),a=/^[A-Z]{2}\\d{2}\\d{3}$/;function o(e){let t=e.trim().toUpperCase();if(a.test(t))return`/api/lookup?code=${encodeURIComponent(t)}`;let n=e.replace(/\\D/g,``);return n.length>=8&&n.length<=9&&/^[\\d\\s-]+$/.test(e.trim())?`/api/lookup?psgc=${encodeURIComponent(n.padStart(9,`0`))}`:`/api/search?q=${encodeURIComponent(e.trim())}&limit=25`}function s(e){t.innerHTML=e.map(e=>{let t=Number(e.psgc)>2?`PSGC ${e.psgc}`:`no PSGC assigned`,n=e.postal?`zip ${e.postal}`:`no zip code`;return`<div class=\"row\">\n              <div class=\"code\">${i(e.code)}</div>\n              <div class=\"place\">${i(e.barangay)}<span>, ${i(e.municipality)}, ${i(e.province)}</span></div>\n              <div class=\"meta\">${t} &middot; ${n}</div>\n            </div>`}).join(``)}var c=e=>{t.innerHTML=`<p class=\"msg\">${i(e)}</p>`},l=0,u;async function d(){let i=e.value.trim(),a=++l;if(!i){t.innerHTML=``,n.hidden=!0;return}let u=o(i);r.textContent=u,n.hidden=!1;try{let e=await fetch(u,{headers:{accept:`application/json`}}),t=await e.json();if(a!==l)return;if(e.status===429){c(t.hint||`Rate limit exceeded.`);return}if(!t.ok){c(t.error||`Request failed with ${e.status}.`);return}let n=Array.isArray(t.data)?t.data:[t.data];if(!n.length){c(`Nothing matches \"${i}\".`);return}s(n)}catch{a===l&&c(`The request failed.`)}}e.addEventListener(`input`,()=>{clearTimeout(u),u=setTimeout(d,180)}),document.querySelectorAll(`[data-example]`).forEach(t=>{t.addEventListener(`click`,()=>{e.value=t.dataset.example??``,e.focus(),d()})});"]],"assets":["/_astro/index.Bth6dTGz.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"XB3QvIOWHyLnmnTkY52t59IqBpl/nxQBGe7WWfFvA9Y=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "9115119b-14ca-4a54-9250-ef78d68ecb86") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
